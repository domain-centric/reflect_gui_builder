...
class $PersonGenderPresentation extends i3.PropertyPresentation {
  ...
  final visible = true;
  @override
  final type = i4.ClassPresentation(
      libraryUri: 'package:reflect_gui_builder/app/person/domain/person.dart',
      className: 'Gender');
  @override
  final widgetFactory = const i5.StringWidgetFactory();
}
...
class $PersonIdPresentation extends i3.PropertyPresentation {
  ...
  final visible = true;
  @override
  final type = i4.ClassPresentation(libraryUri: 'dart:core', className: 'int');
  @override
  final widgetFactory = const i5.StringWidgetFactory();
}
...
class $PersonEMailAddressesPresentation extends i3.PropertyPresentation {
  ...
  final visible = true;
  @override
  final type = i4.ClassPresentation(libraryUri: 'dart:core', className: 'List');
  @override
  final widgetFactory = const i5.StringWidgetFactory();
}
